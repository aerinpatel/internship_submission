        ...
        <main>
          ...
          <section className="container">
            <div className="hero">
              ...
              <div className="hero-image">
                ...
                <img src="\srufer.png" height={1000} alt="Luca the surfer" />
              </div>
            </div>
          </section>
          ...
          <section id="video" className="container">
            ...
            <div className="video-container">
              ...
              <img src="\Episode.png" alt="Leadership Minutes Episode 1" className="video-thumbnail" />
          ...
          <section id="author" className="container">
            <div className="author-section">
              <div className="author-info">
               ...
               {/* Replace with your image */}
              <img src="\849f4ea6ecfa13af5a9575177ceb421cf146c773 (1).png" alt="Author Leslie" className="author-photo"/>
            </div>
          </section>
          ...
          <section className="container">
            ...
            <div className="book-section">
              ...
              <img src="\image.png" alt="Core Feeding Teams book cover" />
              <br/>
